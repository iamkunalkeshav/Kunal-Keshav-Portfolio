...
function initAITerminal() {
  ...
  const knowledge = [
    ...
    { id: "cloud_platforms", keys: ["cloud", "aws", "gcp", "azure", "ec2", "s3", "ecs"], text: "I am highly proficient in AWS and have deployed numerous containerized applications using EC2, S3, and ECS. I'm also familiar with GCP and Azure, but AWS is my go-to for scalable backend infrastructure." },
    { id: "cache_strategies", keys: ["redis", "caching", "memcached", "cache"], text: "I heavily use Redis for distributed caching and pub/sub message brokering. Implementing Redis caching is my first step when optimizing read-heavy endpoints or storing conversational agent memory." },
    { id: "docker_k8s", keys: ["docker", "kubernetes", "k8s", "containerization", "containers", "container"], text: "I containerize all my backend services using Docker for environment parity. For orchestration at scale, I understand Kubernetes concepts like pods, deployments, and services, though I often use managed services like AWS ECS for simplicity." },
    
    // AI Specifics
    { id: "prompt_eng", keys: ["prompt", "engineering", "chain", "thought", "shot"], text: "Prompt engineering is about structure, not just asking nicely. I use advanced techniques like Chain-of-Thought reasoning, Few-Shot prompting, and strict XML/JSON output formatting to guarantee deterministic outputs from LLMs." },
    { id: "memory_agents", keys: ["memory", "remember", "long-term", "conversational"], text: "For agent memory, I implement short-term conversational buffers (using LangChain) and long-term semantic memory using Vector Databases (Chroma/Pinecone) so the agent can recall past interactions accurately." },
    { id: "mcp_protocol", keys: ["mcp", "protocol", "context", "anthropic", "tool", "use"], text: "I am deeply familiar with the Model Context Protocol (MCP). It allows me to standardize how AI agents securely access external tools, APIs, and file systems without writing custom glue code for every new integration." },
    
    // Core Engineering
    { id: "api_design", keys: ["api", "design", "rest", "graphql", "grpc"], text: "I favor REST for its simplicity and universal support. However, for highly interconnected data fetching, I appreciate GraphQL, and for internal microservice-to-microservice communication, I prefer gRPC for its sheer speed and binary serialization." },
    { id: "frontend_skills", keys: ["react", "frontend", "css", "html", "dom", "ui"], text: "While I specialize in AI and Backend, I am highly capable on the frontend. I build modern UIs using React/Next.js, but I also love raw Vanilla DOM manipulation and CSS animations—just like this very portfolio!" },
    { id: "open_source", keys: ["open", "source", "contribute", "github", "contributions"], text: "I actively build open-source tools! My featured projects include a multi-tool autonomous LangGraph agent and a secure enterprise RAG pipeline. I believe in giving back to the community that builds the frameworks I use." },
    
    // Career & Culture
    { id: "work_env", keys: ["ideal", "environment", "culture", "fit", "startup", "enterprise", "corporate"], text: "My ideal environment is one that values engineering excellence and autonomous problem-solving. I thrive in teams that move fast, embrace AI tooling, and foster a culture of blameless post-mortems." },
    { id: "remote_pref", keys: ["wfh", "hybrid", "office", "preference"], text: "I am highly productive in a remote setting and have the discipline for asynchronous communication. However, I am equally happy in a hybrid or office environment if it means collaborating closely with a stellar team." },
    { id: "biggest_fail", keys: ["failure", "mistake", "failed", "over-engineered"], text: "Early on, I once over-engineered a simple data-fetching script using a massive queueing system when a simple cron job would have sufficed. It taught me the ultimate engineering lesson: Keep It Simple, Stupid (KISS)." },
    { id: "five_years", keys: ["five", "years", "future", "goals", "plan", "vision"], text: "In 5 years, I see myself as a Principal AI Engineer or AI Architect, designing massive, autonomous multi-agent systems that solve complex, real-world enterprise problems at scale." },
    { id: "relocation_intl", keys: ["relocate", "international", "us", "europe", "dubai", "move"], text: "I am absolutely open to international relocation for the right opportunity! I am highly adaptable and excited by the prospect of working in global tech hubs like the US, Europe, or the UAE." },
    { id: "weekend_work", keys: ["weekend", "weekends", "overtime", "hustle"], text: "I am dedicated and will absolutely put in the extra hours during a critical launch or production outage. However, I believe consistent overtime is a sign of poor sprint planning, and sustainable pacing produces the best code." },
    
    // Soft Skills & Extras
    { id: "fav_book", keys: ["book", "reading", "read", "books"], text: "For engineering, I highly recommend 'Designing Data-Intensive Applications' by Martin Kleppmann. It fundamentally changed how I view distributed systems and database architectures." },
    { id: "imposter", keys: ["imposter", "syndrome", "overwhelmed", "doubt"], text: "In the rapidly evolving AI space, everyone feels imposter syndrome! I combat it by staying curious, accepting that I can't know everything, and focusing on mastering the fundamental principles of computer science." },
    { id: "auth_authz", keys: ["oauth2", "jwt", "authorization", "rbac", "authz"], text: "I strictly separate Authentication (who you are) from Authorization (what you can do). I use JWTs for stateless auth and implement rigorous Role-Based Access Control (RBAC) middleware on my backend routes." },
  ...
  function getBotResponse(query) {
    ...
    const phraseMap = [
      ...
      { phrase: "contact", targetId: "contact" },
      { phrase: "reach you", targetId: "contact" },
      { phrase: "get in touch", targetId: "contact" },
      { phrase: "email", targetId: "contact" },
      { phrase: "message you", targetId: "contact" },
      { phrase: "current job", targetId: "work" },
      { phrase: "what you are building", targetId: "projects" },
      { phrase: "what are you building", targetId: "projects" },
      { phrase: "what have you built", targetId: "projects" },
      ...
      // Cloud & Infrastructure
      { phrase: "cloud experience", targetId: "cloud_platforms" },
      { phrase: "aws vs azure", targetId: "cloud_platforms" },
      { phrase: "do you know gcp", targetId: "cloud_platforms" },
      { phrase: "cloud architecture", targetId: "cloud_platforms" },
      { phrase: "deploy applications", targetId: "cloud_platforms" },
      { phrase: "redis", targetId: "cache_strategies" },
      { phrase: "caching", targetId: "cache_strategies" },
      { phrase: "memcached", targetId: "cache_strategies" },
      { phrase: "how do you cache data", targetId: "cache_strategies" },
      { phrase: "distributed caching", targetId: "cache_strategies" },
      { phrase: "docker", targetId: "docker_k8s" },
      { phrase: "kubernetes", targetId: "docker_k8s" },
      { phrase: "k8s", targetId: "docker_k8s" },
      { phrase: "containerization", targetId: "docker_k8s" },
      { phrase: "orchestrate containers", targetId: "docker_k8s" },

      // AI Specifics
      { phrase: "prompt engineering", targetId: "prompt_eng" },
      { phrase: "chain of thought", targetId: "prompt_eng" },
      { phrase: "few shot", targetId: "prompt_eng" },
      { phrase: "how to write prompts", targetId: "prompt_eng" },
      { phrase: "system prompt", targetId: "prompt_eng" },
      { phrase: "agent memory", targetId: "memory_agents" },
      { phrase: "long term memory", targetId: "memory_agents" },
      { phrase: "conversational memory", targetId: "memory_agents" },
      { phrase: "how do agents remember", targetId: "memory_agents" },
      { phrase: "semantic memory", targetId: "memory_agents" },
      { phrase: "mcp", targetId: "mcp_protocol" },
      { phrase: "model context protocol", targetId: "mcp_protocol" },
      { phrase: "anthropic mcp", targetId: "mcp_protocol" },
      { phrase: "tool use", targetId: "mcp_protocol" },
      { phrase: "function calling", targetId: "mcp_protocol" },

      // Core Engineering
      { phrase: "api design", targetId: "api_design" },
      { phrase: "rest vs graphql", targetId: "api_design" },
      { phrase: "grpc", targetId: "api_design" },
      { phrase: "how do you design apis", targetId: "api_design" },
      { phrase: "build an api", targetId: "api_design" },
      { phrase: "react", targetId: "frontend_skills" },
      { phrase: "frontend skills", targetId: "frontend_skills" },
      { phrase: "css framework", targetId: "frontend_skills" },
      { phrase: "do you write frontend", targetId: "frontend_skills" },
      { phrase: "vanilla js", targetId: "frontend_skills" },
      { phrase: "open source", targetId: "open_source" },
      { phrase: "contribute to open source", targetId: "open_source" },
      { phrase: "github contributions", targetId: "open_source" },
      { phrase: "open-source projects", targetId: "open_source" },
      { phrase: "community contributions", targetId: "open_source" },

      // Career & Culture
      { phrase: "ideal work environment", targetId: "work_env" },
      { phrase: "culture fit", targetId: "work_env" },
      { phrase: "what kind of company", targetId: "work_env" },
      { phrase: "startup or enterprise", targetId: "work_env" },
      { phrase: "company culture", targetId: "work_env" },
      { phrase: "wfh", targetId: "remote_pref" },
      { phrase: "work from home", targetId: "remote_pref" },
      { phrase: "hybrid", targetId: "remote_pref" },
      { phrase: "office preference", targetId: "remote_pref" },
      { phrase: "remote work", targetId: "remote_pref" },
      { phrase: "biggest failure", targetId: "biggest_fail" },
      { phrase: "mistake you made", targetId: "biggest_fail" },
      { phrase: "failed project", targetId: "biggest_fail" },
      { phrase: "time you failed", targetId: "biggest_fail" },
      { phrase: "biggest mistake", targetId: "biggest_fail" },
      { phrase: "where do you see yourself in 5 years", targetId: "five_years" },
      { phrase: "future goals", targetId: "five_years" },
      { phrase: "5 year plan", targetId: "five_years" },
      { phrase: "career goals", targetId: "five_years" },
      { phrase: "where are you heading", targetId: "five_years" },
      { phrase: "willing to move to us", targetId: "relocation_intl" },
      { phrase: "relocate to europe", targetId: "relocation_intl" },
      { phrase: "dubai", targetId: "relocation_intl" },
      { phrase: "international relocation", targetId: "relocation_intl" },
      { phrase: "relocate abroad", targetId: "relocation_intl" },
      { phrase: "work on weekends", targetId: "weekend_work" },
      { phrase: "overtime", targetId: "weekend_work" },
      { phrase: "hustle culture", targetId: "weekend_work" },
      { phrase: "long hours", targetId: "weekend_work" },
      { phrase: "work late", targetId: "weekend_work" },

      // Soft Skills & Extras
      { phrase: "favorite book", targetId: "fav_book" },
      { phrase: "reading", targetId: "fav_book" },
      { phrase: "what do you read", targetId: "fav_book" },
      { phrase: "book recommendations", targetId: "fav_book" },
      { phrase: "recommend a book", targetId: "fav_book" },
      { phrase: "imposter syndrome", targetId: "imposter" },
      { phrase: "feeling overwhelmed", targetId: "imposter" },
      { phrase: "doubt", targetId: "imposter" },
      { phrase: "feel like an imposter", targetId: "imposter" },
      { phrase: "overcome doubt", targetId: "imposter" },
      { phrase: "oauth2", targetId: "auth_authz" },
      { phrase: "jwt", targetId: "auth_authz" },
      { phrase: "authorization", targetId: "auth_authz" },
      { phrase: "rbac", targetId: "auth_authz" },
      { phrase: "authentication", targetId: "auth_authz" },
      { phrase: "team player", targetId: "team_player" },
      { phrase: "solo contributor", targetId: "team_player" },
      { phrase: "work alone", targetId: "team_player" },
      { phrase: "collaborate", targetId: "team_player" },
      { phrase: "independent worker", targetId: "team_player" },
      { phrase: "why you", targetId: "why_hire" },
      { phrase: "why should we hire kunal", targetId: "why_hire" },
